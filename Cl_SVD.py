...
np.savetxt(DataDir + 'K_for2Eval.txt', K)   # Basis
np.savetxt(DataDir + 'W_for2Eval.txt', W)   # Weights

np.savetxt(DataDir + 'stdy.txt', [stdy])
np.savetxt(DataDir + 'yRowMean.txt',yRowMean)
...
plt.tight_layout()
plt.savefig(PlotsDir + 'SVD_TruncatedWeights.png')
